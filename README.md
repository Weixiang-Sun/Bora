...
<div align="center">
    ...
    <a href="https://huggingface.co/datasets/Sweson/Bora_v1"><img src="https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Data-red"></a>
</div>
...
## 📰 News
- **[2024.6]** The first version of our [training data](https://huggingface.co/datasets/Sweson/Bora_v1) is released.
- **[2024.6]** We release **Bora**, a video generation model specificaly for biomedical domain.
...
## Citation
If you're using Bora or our dataset in your research or applications, please cite using this BibTeX:
```bibtex
@article{sun2024bora,
